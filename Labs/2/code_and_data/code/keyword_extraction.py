...
path_to_abstracts = '../data/abstracts'# fill me (absolute path)
...
path_to_keywords = '../data/uncontr' # fill me (absolute path)
...
for vector in vectors_list:
    ...
    nonzero = [(term, weight) for term, weight in terms_weights if weight > 0]
